...
## 对接口的实现:
  ...
  2. **单词统计的接口是：**public void wordCount(BufferedReader in, Map<String,Integer> map)
...
18. 使用有大量内容的电子书做随机测试  
19. 具体的测试用例截图：  
![这个是测试用例的截图](https://raw.github.com/yourName/repositpry/master/yourprojectName/img-folder/test.jpg)  
...
```  
    ...
    * 单元测试的运行截图：  
![这个是测试程序代码](https://raw.github.com/yourName/repositpry/master/yourprojectName/img-folder/test.jpg)  
    * 由测试的结果来看目前给出的20个测试用例都已经通过了测试，测试质量还不错，被测试模块的质量基本符合要求但这不代表  
      程序一定正确，可能还有其它小小问题没有被发现，之后可以增加测试情况的种类来测试程序，发现问题并修改，来增加程序  
      的健壮性
